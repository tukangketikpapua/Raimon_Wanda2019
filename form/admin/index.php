...
$r =mysqli_query($conn," SELECT * FROM tb_registrasi limit 0,5 ");
...
<?php while($row=mysqli_fetch_array($r)){ ?>
                       <li class="divider"></li>
                        <li>
                            <a href="lihat/reg.php?nik=<?=$row ['NIK'] ?>">
                                <div>
                                    <strong><span class=" label label-danger"><?= $row['NIK'] ?></span></strong>
                                    <span class="pull-right text-muted">
                                        <em><?= $row['tgl_registrasi'] ?></em>
                                    </span>
                                </div>
                                <div><?= $row['nama_ormas'] ?></div>
                            </a>
                            <li class="divider"></li>
...
<!--                         <ul class="nav nav-second-level">
                    ...
                    <ul class="nav nav-second-level">
                        <li>
                            <a href="lihat/dt_kegiatan.php" style="color: yellow">- Kegiatan Organisasi</a>
                        </li>
                        <li>
