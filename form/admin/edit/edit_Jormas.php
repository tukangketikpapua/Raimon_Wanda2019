...
$kdo=$_GET["kd_organisasi"];
$result=mysqli_query($conn,"SELECT * FROM tb_organisasi WHERE kd_organisasi = '$kdo';");

require '../../function/function_update.php';
if(isset($_POST["submit"]) ){
//cek apakah data berhasil di tambahkan
if(edit_Jormas($_POST)> 0) {
    echo "<script>
                    ...
                    <div class="panel-body">
                        <div class="table-responsive">
                            <table class="table">
                                ...
                                <p><input type="text" size="10%" name="kd_ormas" value="<?= $row ["kd_organisasi"]; ?>" " readonly="true"></p>
                                <label for="nm_ormas">Nama Organisasi</label>
                                <p><input type="text" name="nm_ormas" size="100%"value="<?= $row ["jenis_organisasi"]; ?>" "  required></p>
                            </table>
                            <!-- Advanced Tables -->
                        </div>
                    </div>
