...
$idp=$_GET["id_persyaratan"];
$result=mysqli_query($conn,"SELECT * FROM tb_persyaratan WHERE id_persyaratan = '$idp';");

require '../../function/function_update.php';
if(isset($_POST["submit"]) ){
//cek apakah data berhasil di tambahkan
if(edit_syarat($_POST)> 0) {
    echo "<script>
                    ...
                    <div class="panel-body">
                        <div class="table-responsive">
                            <table class="table">
                                ...
                                <p><input type="text" size="10%" name="kd_syarat" value="<?= $row ["id_persyaratan"]; ?>" readonly="true"></p>
                                <label for="syarat">Syarat</label>
                                <p><input type="text" name="syarat" size="100%"value="<?= $row ["persyaratan"]; ?>"  required></p>
                            </table>
                            <!-- Advanced Tables -->
<?php } ?>
<?php } ?>
