                        ...
                        <div class="panel panel-default">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h2>Data Organisasi Terdaftar</h2>
                                </div>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                        <thead>
                                            <tr>
                                                <th width="2%" >No</th>
                                                <th width="7%"><center>tgl daftar</center></th>
                                                <th width="7%"><center>kode berkas</center></th>
                                                <th width=""><center>Organisasi</center></th>
                                                <th width="8%"><center>NIK pengurus</center></th>
                                                <th width=""><center>Jenis organisasi</center></th>
                                                <th width="7%"><center>distrik</center></th>
                                                <th width=""><center>alamat</center></th>
                                                <th width="2%"></th>
                                                <th width="2%"></th>
                                                <th width="2%"></th>
                                            ...
                                            <?php if(mysqli_num_rows($result5)){ ?>
                                                <?php while($row=mysqli_fetch_array($result5)){ ?>
                                                    <tr>
                                                        ...
                                                        <td class=><a href=" " class="btn btn-primary btn-xs" onclick=" return confirm('  ');">hapus data<a>
                                                            <td class=><a href="../download/download.php?kd_berkas=<?= $row ["kd_berkas"]; ?>" class="btn btn-primary btn-xs" onclick=" return confirm('Download berkas !!!');">download file<a>
                                                                <td class=><a href="../validasi/validasi.php?kd_berkas=<?= $row ["kd_berkas"]; ?>" class="btn btn-primary btn-xs" onclick=" return confirm('Ingin Validasi Berkas!');">Validasi data<a>
