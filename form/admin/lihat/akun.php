...
<td class=><a href=" " class="btn btn-primary btn-xs" onclick=" return confirm('  ');">hapus<a>
<td class=><a href="email.php?kd_akun=<?= $row ['kd_akun']; ?>" class="btn btn-primary btn-xs" onclick=" return confirm('  ');">kirim akun<a>
