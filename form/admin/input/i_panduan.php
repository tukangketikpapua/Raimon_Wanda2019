...
if(simpan_panduan($_POST)> 0) {
    echo "<script>
            alert('data berhasil disimpan');
            document.location.href = 'i_panduan.php';
            </script>";
} else {
    echo "<script>
                    ...
                    <div class="panel-body">
                        <div class="table-responsive">
                            <table class="table">
                                ...
                                <p><input type="text" size="10%" name="kd_panduan" value="<?php echo $panduan;?>" readonly="true"></p>
                                <label for="panduan">Panduan</label>
                                <p><input type="text" name="panduan" size="100%"value="" autocomplete="off"  required></p>
                            </table>
                            <!-- Advanced Tables -->
                        </div>
                    </div>
                  ...
                  <div class="table-responsive">
                      <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                        <thead>
                          <tr>
                            <th width="5%" >No</th>
                            <th width="10%"><center>kd Panduan </center></th>
                            <th width="80%"><center>Panduan Pendaftaran</center></th>
                            <th></th>
                            <th></th>
                          </tr>
                        </thead>
                          ...
                          <tr>
                            <td><?= $i; ?></td>
                            <td class=><?= $row ["kd_panduan"]; ?></td>
                            <td class=><?= $row ["Panduan_Pendaftaran"]; ?></td>
<td style="font-size: 10px" class=><a href="../hapus/hapus_panduan.php?kd_panduan=<?= $row ["kd_panduan"]; ?>" class="btn btn-primary btn-xs" onclick=" return confirm('Yakin akan hapus data ?  ');">hapus<a>
<td><a  href="../edit/edit_panduan.php?kd_panduan=<?= $row ["kd_panduan"]; ?>" class="btn btn-primary btn-xs"  onclick=" return confirm('Yakin edit Data ???');">edit<a></td>
                          </tr>
                            <?php $i++; ?>
                            <?php } ?>
                            <?php } ?>
