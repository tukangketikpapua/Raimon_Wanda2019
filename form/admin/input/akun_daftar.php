...
$kd=$_GET["NIK"];
$r =mysqli_query($conn," SELECT * FROM tb_registrasi WHERE NIK='$kd' ");
$akundaftar=mysqli_query($conn," SELECT * FROM akun_daftar ");


if(isset($_POST["register"]) ){
//cek apakah data berhasil di tambahkan
if(daftar_akun($_POST)> 0) {
                    ...
                    <div class="panel-body">
                        <div class="table-responsive">
                            <table class="table">
                                ...
                                <p><input type="text" name="nama_ormas" size="35%" value="<?= $row ["nama_ormas"]; ?>"  readonly></p>
                                <label for="nik_pengurus">nik pengurus</label>
                                <p><input type="text" name="nik" size="35%" value="<?= $row ["NIK"]; ?>"  readonly></p>
                                                    ...
                                                    <div class="table-responsive">
                                                        <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                                            <thead>
                                                                <tr>
                                                                    <th width="2%" >No</th>
                                                                    <th width="14%"><center>NIK pengurus</center></th>
                                                            ...
                                                            <tbody>
                                                                <?php $i = 1; ?>
                                                                <?php if(mysqli_num_rows($akundaftar)){ ?>
                                                                    <?php while($row=mysqli_fetch_array($akundaftar)){ ?>
