                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="table-responsive">
                            <table class="table">
                                <label for="kd_syarat">Kd Syarat</label>
                                <p><input type="text" size="10%" name="kd_syarat" value="<?php echo $syarat;?>" readonly="true"></p>
                                <label for="syarat">Syarat</label>
                                <p><input type="text" name="syarat" size="100%"value="" autocomplete="off"  required></p>
                            </table>
                            <!-- Advanced Tables -->
                        </div>
                    </div>
                                                    ...
                                                    <div class="table-responsive">
                                                        <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                                            <thead>
                                                                <tr>
                                                                    <th width="2%" >No</th>
                                                                    <th width="10%"><center>kd syarat</center></th>
                                                                    <th width="100%"><center>syarat</center></th>
                                                                    <th></th>
                                                                    <th></th>
                                                                </tr>
                                                            </thead>
                                                            ...
                                                            <?php while($row=mysqli_fetch_array($result3)){ ?>
                                                                        <tr>
                                                                            <td><?= $i; ?></td>
                                                                            <td class=><?= $row ["id_persyaratan"]; ?></td>
                                                                            <td class=><?= $row ["persyaratan"]; ?></td>
<td style="font-size: 10px" class=><a href="../hapus/hapus_syarat.php?id_persyaratan=<?= $row ["id_persyaratan"]; ?>" class="btn btn-primary btn-xs" onclick=" return confirm('Yakin akan hapus data ?  ');">hapus<a>
<td><a  href="../edit/edit_syarat.php?id_persyaratan=<?= $row ["id_persyaratan"]; ?>" class="btn btn-primary btn-xs"  onclick=" return confirm('Yakin edit Data ???');">edit<a></td>
                                                                        </tr>
                                                            <?php $i++; ?>
                                                            <?php } ?>
                                                            <?php } ?>
