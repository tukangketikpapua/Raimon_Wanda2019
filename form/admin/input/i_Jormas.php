...
if(simpan_ormas($_POST)> 0) {
    echo "<script>
            alert('data berhasil disimpan');
            document.location.href = '../input/i_Jormas.php';
            </script>";
} else {
    echo "<script>
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="table-responsive">
                            <table class="table">
                                <label for="kd_ormas">kd Organisasi</label>
                                <p><input type="text" size="10%" name="kd_ormas" value="<?php echo $ormas;?>" readonly="true"></p>
                                <label for="nm_ormas">Nama Organisasi</label>
                                <p><input type="text" name="nm_ormas" size="100%"value=""  required></p>
                            </table>
                            <!-- Advanced Tables -->
                        </div>
                    </div>
                                                    ...
                                                    <div class="table-responsive">
                                                        <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                                            <thead>
                                                                <tr>
                                                                    <th width="2%" >No</th>
                                                                    <th width="10%"><center>kd Organisasi</center></th>
                                                                    <th width="80%"><center>Nama Organisasi</center></th>
                                                                    <th></th>
                                                                    <th></th>
                                                                </tr>
                                                            </thead>
                                                            <tbody>
                                                                ...
                                                                <?php if(mysqli_num_rows($result2)){ ?>
                                                                    <?php while($row=mysqli_fetch_array($result2)){ ?>
                                                                        <tr>
                                                                            <td><?= $i; ?></td>
                                                                            <td class=><?= $row ["kd_organisasi"]; ?></td>
                                                                            <td class=><?= $row ["jenis_organisasi"]; ?></td>
                                                                           
 <td style="font-size: 10px" class=><a href="../edit/edit_Jormas.php?kd_organisasi=<?= $row ["kd_organisasi"]; ?>" class="btn btn-primary btn-xs" onclick=" return confirm('Yakin akan  edit data ?  ');">edit<a>
    <td><a  href="" class="btn btn-primary btn-xs"  onclick=" return confirm('Yakin hapus Data ???');">hapus<a></td>
                                                                        </tr>
                                                                        <?php $i++; ?>
                                                                    <?php } ?>
                                                                <?php } ?>
