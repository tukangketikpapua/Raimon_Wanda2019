...
error_reporting(0);
$result = mysqli_query($conn,"SELECT * FROM tb_daftar" );  global $conn;
//UPLOAD GAMBAR
if(isset($_POST['simpan'])){
    $tgl= $_POST["tgl_daftar"]; 
    $nik = $_POST["NIK"];      
    $nama = $_POST["nama_ormas"];
    $berkas = $_POST["syarat"];
    $file=$_FILES["file"]["name"];

    $tmp_name=$_FILES["file"]["tmp_name"];

    move_uploaded_file($tmp_name,"../user/foto/".$file);
    if(isset($_POST)> 0) {
        ...
        document.location.href = 'daftar_baru.php';
    ...
    $query  = "INSERT INTO tb_daftar VALUES ('','$tgl','$nik','$nama','$berkas','$file')";
                                        ...
                                        <div class="panel-body" >
                                            ...
                                            <div class="panel panel-default">
                                                ...
                                                <?php if(mysqli_num_rows($result1)){ ?>
                                                    ...
                                                    <?php }else{
                                                        echo '<tr><td><center>MAAF ! BELUM ADA INFORMASI !!!</center></td></tr>';
                                                    }?>
