...
$info =mysqli_query($conn," SELECT * FROM tb_ormas where id LIKE '%2%'  "); 
$info2 =mysqli_query($conn," SELECT * FROM tb_ormas where id LIKE '%3%'  "); 
$info3 =mysqli_query($conn," SELECT * FROM tb_ormas where id LIKE '%4%'  "); 
                                ...
                                <table class="table">
                                    <thead style="font-size: 12px">
                                        <tr>
                                            ...
                                            <th style="width: 5%">Tgl Upload</th>
...
<!-- end #content -->
<div id="footer">
  <p id="legal">2019 Biak. Design By @PapuaKoding</a></p></li>
</div>
<!-- end #footer -->
</body>
