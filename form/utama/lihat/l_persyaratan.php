...
$result =mysqli_query($conn," SELECT * FROM tb_persyaratan ");
                                ...
                                <table class="table">
                                    <thead style="font-size: 12px">
                                        <tr>
                                            ...
                                            <th style="text-align: center">Syarat Pendaftaran</th>
...
<?php } ?> 
      <li>
       <button class="btn btn-outline btn-danger btn-sm" data-toggle="modal" data-target="#login-modal">Login Akun</button>
        <ul>
...
<!-- end #content -->
<div id="footer">
  <p id="legal">Copyright &copy; 2019 Biak. Design By @PapuaKoding</a></p>
</div>
<!-- end #footer -->
</body>
