                                        ...
                                        <div class=" 12">                              
                                            <!-- Advanced Tables -->
                                                ...
                                                <div class="panel panel-default">
                                                    <div class="panel panel-default">
                                                        <div class="panel-heading">
                                                            <h2>Data Kegiatan Organisasi</h2>
                                                        </div>
                                                        <div class="panel-body">                
                                                            <div class="table-responsive">
                                                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
...
<td><a  href="foto_kegiatan.php?nik_pengurus=<?= $row ["nik_pengurus"]; ?>" class="btn btn-primary btn-xs"  onclick=" return confirm('Lihat Gambar ???');">Lihat Gambar<a></td>
